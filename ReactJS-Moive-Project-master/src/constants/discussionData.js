const discussData = [
  {
    ...
    point: 9,
    post:
      "Xem trailer hấp dẫn quá, cuối tuần này phải rủ Putin đi xem mới được",
    likes: 69,
    isLiked: false,
  },
  {
  ...
  },
  {
    ...
    point: 8,
    post:
      "Hì hì, hôm qua dắt crush đi coi xong thì hôm nay crush thành người yêu mình rồi <3",
    likes: 29,
    isLiked: false,
  },
  {
  ...
  },
  {
    ...
    point: 8,
    post:
      "Phim này nhiều tình tiết tấu hài nếu áp dụng ngoài đời chắc sẽ gây ấn tượng mạnh lắm :))",
    likes: 32,
    isLiked: false,
  },
  {
...

  {
    ...
    point: 10,
    post:
      "Xuất sắc, kịch tính và không kém phần hài hước, muốn đi xem lại lần 2",
    likes: 4,
    isLiked: false, 
  },
  {
    ...
    point: 3,
    post:
      "Ai bảo phim hay, hôm qua dắt mấy đứa con đi xem tụi nó ngủ hết trong rạp >.<",
    likes: 2,
    isLiked: false,
  },
  ...
  },
  {
    ...
    point: 7,
    post:
      "Lại là em đây, hôm nay là ngày cuối khuyến mãi rồi nha mọi người ơi, ghé ghé shop em nào",
    likes: 1,
    isLiked: false,
  },
  {
